...
const ipadModels = [
  {
    id: "ipad-pro",
    title: "iPad Pro",
    colors: ["#232426", "#E3E4E5"], // Space Black, Silver
  ...
  },
  {
    id: "ipad-air",
    title: "iPad Air",
    colors: ["#232426", "#E3E4E5", "#D1D5DB", "#E0E7FF"], // Space Gray, Starlight, Purple, Blue
  ...
  },
  {
    ...
    colors: ["#4B5563", "#FCA5A5", "#FDE047", "#3B82F6"], // Silver, Pink, Yellow, Blue
  ...
  },
  {
    id: "ipad-mini",
    title: "iPad mini",
    colors: ["#4B5563", "#E5E7EB", "#E0E7FF", "#FCA5A5"], // Space Gray, Starlight, Purple, Pink
...
export default function AllModel1() {
  ...
  const handleScroll = (direction) => {
    if (sliderRef.current) {
      // 384px (card width) + 20px (gap-5) = 404px
  ...
  return (
    <div className="space-y-6 w-full mt-10 relative group/slider">
      ...
      {/* Main Wrapper Box to handle relative button placement */}
      <div className="relative w-full">
        ...
        >
          {ipadModels.map((ipad, index) => (
            // Appended index to key to safeguard against the duplicate array IDs in your mock data
          ...
          {ipad.colors.map((color, index) => (
            <button
              ...
              className={`
                ...
                rounded-full
                transition-all
                ${selectedColor === index ? "" : " cursor-pointer hover:opacity-80"}
              `}
            />
          ))}
        </div>
