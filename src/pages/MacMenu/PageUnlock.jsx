    ...
    <section className="bg-white pt-14 pb-9 w-full overflow-hidden font-sans antialiased">
      <div className="max-w-[1264px] mx-auto px-6 md:px-0">
        ...
        <div className="bg-[#f5f5f7] rounded-2xl p-8 md:p-14 flex flex-col md:flex-row items-center justify-between min-h-[580px] shadow-[0_1px_3px_rgba(0,0,0,0.02)] ease-out gap-12">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    <h3
                      className={`text-[20px] md:text-[22px] font-semibold tracking-tight duration-300 ${
                        isOpen ? "" : "text-black"
                      }`}
                    >
                      {item.title}
          ...
          <div className="w-full md:w-[65%] flex justify-center items-center relative min-h-[300px] md:min-h-[400px]">
            {accordionData.map((item, index) => {
              ...
              return (
                ...
                >
                  <img
                    src={item.image}
                    alt={item.alt}
                    className="max-w-full max-h-[570px] object-contain transition-transform duration-700 ease-out"
                  />
                </div>
              );
            })}
