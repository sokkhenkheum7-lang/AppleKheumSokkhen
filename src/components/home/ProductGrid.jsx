...
import promo1 from "../../assets/banner/promo_ipad1.jpg";
import promo2 from "../../assets/banner/promo_ipad2.jpg";
import promo3 from "../../assets/banner/promo_ipad3.jpg";
import promo4 from "../../assets/banner/promo_ipad4.jpg";
import promo5 from "../../assets/banner/promo_ipad5.jpg";
import promo6 from "../../assets/banner/promo_ipad6.jpg";
...
const products = [
  ...
  },
  {
    ...
    image:promo2,
    bgClass: "bg-gradient-to-b from-[#c9e8f8] to-[#eef7fc]",
    isIpadAir: true,
  },
  {
    title: "MacBook Pro",
          ...
          return (
            ...
            >
              <div className="z-10 flex flex-col items-center px-6 pt-10 text-center md:pt-14">
                ...
                <p
                  className={`mt-2 max-w-[360px] text-sm leading-snug sm:text-base md:text-lg ${
                    isDark ? "text-[#b4b4b8]" : "text-[#1d1d1f]"
                  }`}
                >
                  {description}
                </p>
              ...
              <div className="flex h-[55%] items-end justify-center overflow-hidden pb-4">
                <img
                  src={image}
                  alt={title}
                  draggable={false}
                  className="h-full max-h-[95%] object-contain transition-transform duration-500 hover:scale-105"
                />
              </div>
            </article>
          );
